...
export async function classifyResume(rawText) {
...
export async function getATSScore(rawText, jobDescription) {
...
export async function generateApplicationDocs(resumeText, jobDescription, userProfile) {

...
export async function sendApplicationConfirmation(user, job, application) {
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          <p style="color: #64748b; font-size: 13px; margin-top: 24px;">
            Good luck with your application! Track your progress in your 
            <a href="${process.env.CLIENT_URL}/dashboard">Smart Job Applier dashboard</a>.
          </p>
        </div>
      `,
    });
